...
<table border="0" width="900" cellpadding="5" cellpadding="0" align="center">
	<tr>
      ...
      <BR>
		...
		<td>
		<td><H1  align="center">Хиты продаж</H1>
			
			
			<p>
			<a href="https://shop.ctepx.ru/product/zhalyuzi-gorizontalnye-alyuminievye-tango-25-neytralnye-belo-serye-i-chyornye-tsveta/">
   <img width="150" align="left" src="https://shop.ctepx.ru/wa-data/public/shop/products/00/webp/02/00/2/images/2/2.0x460@2x.webp">
      </a>
				Жалюзи горизонтальные алюминиевые глянцевые «Танго 25» «Нейтральные бело-серые цвета» - это классические горизонтальные жалюзи с глянцевыми, однотонно окрашенными в нейтральные цвета, ламелями (пластинами) шириной 25 мм. 
			</p>
        ...
        <BR>
			<table border="3" cellpadding="20" cellspacing="5">
 			...
 			<tr>
				<td rowspan=3><a href="https://shop.ctepx.ru/product/shtora-rulonnaya-mini-alfa/">
   <img width="150" src="https://shop.ctepx.ru/wa-data/public/shop/products/00/webp/75/00/75/images/417/417.0x460@2x.webp">
      </a></td>
				<td colspan=2 align="center">Штора рулонная с цепочным приводом «Мини», коллекция «Альфа»</td>
			</tr>
			<tr>
				<td>10 цветов ткани</td>
				<td>2 цвета фурнитуры</td>
			</tr>
			<tr>
				<td >6 вариантов отделки нижнего края полотна</td>
				<td >1 221,02 ₽</td>
			</tr>
			</table><BR>
			Популярные цвета:<BR>
      ...
      Варианты намотки:<BR>
          ...
          <ol type="a">
				...
				<li>Дополнительная комплектация
          <ol type="a">
						<li>Магнитные фиксаторы нижней планки [А04064]
						</li>
						<li>Механические фиксаторы нижней планки [01877]
						</li>
					</ol>
				</li>
			</ol>
