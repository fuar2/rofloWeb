...
<table border="0" width="900" cellpadding="5" cellpadding="0" align="center">
	<tr>
      ...
      <BR>
		...
		<td>
<td><H1  align="center">Регистрация</H1>

<!-- Форма регистрации -->
<form action="/register.php" method="POST" style="width: 400px; margin: auto;">
    <input style="width:100%; height:30px; border-radius: 10px; margin-bottom: 10px;" type="text" name="username" placeholder="Ваше имя" required>
    ...
    <button style="width:100%; height:35px; border-radius: 10px;" type="submit">Зарегистрироваться</button>
