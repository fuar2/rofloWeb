...
<table border="0" width="900" cellpadding="5" cellpadding="0" align="center">
	<tr>
      ...
      <h2 class ="coolZagolovok">Лента новостей</h2>
      ...
      <BR>
		...
		<td bgcolor="#ff8000">
		<H1 class ="coolZagolovok kontakt">Напишите нам!</H1>
      <table class="kontakt">
			<tr>
				<td><input style="width:400px;height:30px;border-radius: 10px;" type="login" placeholder="Ваше имя"></td>
			</tr>
			<tr>
				<td><input style="width:400px;height:30px;border-radius: 10px;" type="text" placeholder="Ваш текст"></td>
			</tr>
					<tr>
				<td align="right" ><input class="asd" style="width:80px;height:30px;" type="button" value="Отправить"></td>
			</tr>
		</table>
        <BR>
		</td>
